...
Prerequisites: modern-python 5.4, 12.5, 18.4 · Depends on backend modules: 01, 02

Read top to bottom. Every notebook follows [AUTHORING-GUIDE.md](../AUTHORING-GUIDE.md).

| # | Notebook | Level | Status |
|---|---|---|---|
| 03.1 | [Application structure and ASGI - what uvicorn actually does](03.1-application-structure-and-asgi.md) | Beginner | todo |
| 03.2 | [Routing and parameters](03.2-routing-and-parameters.md) | Beginner | todo |
| 03.3 | [Request/response models](03.3-request-response-models.md) | Beginner | todo |
| 03.4 | [Pydantic v2 in depth - validation modes, serialisation, settings](03.4-pydantic-v2-in-depth.md) | Intermediate | todo |
| 03.5 | [Dependency injection](03.5-dependency-injection.md) | Intermediate | todo |
| 03.6 | [Sync vs async endpoints - the threadpool](03.6-sync-vs-async-endpoints.md) | Intermediate | todo |
| 03.7 | [Middleware](03.7-middleware.md) | Intermediate | todo |
