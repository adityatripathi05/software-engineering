...
- **Every REPL transcript, log excerpt or numeric output you show must be generated by actually
  running the code** on the pinned stack (Python 3.14 / Pydantic 2.13 / SQLAlchemy 2.0 / FastAPI
  0.13x) — never written from memory. Float arithmetic, rounding, coercion behaviour and library
