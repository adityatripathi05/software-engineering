...
Prerequisites: modern-python 11.1-11.5 · Depends on backend modules: -

Read top to bottom. Every notebook follows [AUTHORING-GUIDE.md](../AUTHORING-GUIDE.md).

| # | Notebook | Level | Status |
|---|---|---|---|
| 01.1 | [Request/response lifecycle - socket to ASGI to handler](01.1-request-response-lifecycle.md) | Beginner | done |
| 01.2 | [HTTP methods, safety and idempotency](01.2-methods-safety-idempotency.md) | Beginner | done |
| 01.3 | [Status codes and headers](01.3-status-codes-and-headers.md) | Beginner | done |
| 01.4 | [Content negotiation, compression and HTTP caching - ETag, Cache-Control, conditional requests](01.4-content-negotiation-and-http-caching.md) | Intermediate | done |
| 01.5 | [Cookies and sessions](01.5-cookies-and-sessions.md) | Beginner | done |
| 01.6 | [Stateless vs stateful services](01.6-stateless-vs-stateful.md) | Beginner | done |
| 01.7 | [Connection lifecycle - keep-alive, HTTP/1.1 vs 2 vs 3](01.7-connection-lifecycle.md) | Intermediate | done |
| 01.8 | [TLS fundamentals](01.8-tls-fundamentals.md) | Intermediate | done |
| 01.9 | [CORS - preflight, browser security model, misconfiguration](01.9-cors.md) | Intermediate | done |
| 01.10 | [Reverse proxies and load balancers - X-Forwarded-*, trusting proxy headers](01.10-reverse-proxies-and-forwarded-headers.md) | Intermediate | done |
