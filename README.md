...
| [`backend-development/`](backend-development/) | **In progress** — modules 01–02 written, 23/261 notebooks | Building one service correctly: HTTP, FastAPI, PostgreSQL, auth, caching, Docker, CI/CD |
...
Curriculum approved (2026-08-24). Modules 01–02 are written; the rest follow module by module.
